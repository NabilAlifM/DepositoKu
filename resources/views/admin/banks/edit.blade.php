...
<div class="max-w-3xl mx-auto">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 border-b">
            <h3 class="text-lg font-semibold text-gray-800">Edit Data Bank</h3>
        </div>
        
        <form action="{{ route('admin.banks.update', $bank->bank_id) }}" 
              method="POST" 
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Format: JPG, PNG, GIF, SVG. Max: 2MB. Kosongkan jika tidak ingin mengubah logo.</p>
                @error('logo')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
